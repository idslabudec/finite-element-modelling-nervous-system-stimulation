function out = model
%
% cortical_ModRefinedMultiscale.m
%
% Model exported on Oct 8 2024, 15:08 by COMSOL 6.2.0.290.
...
model.label('1_5_largest_electrode_bipolar.mph');
...
model.result.dataset('cln1').setIndex('genpoints', '-0.00005', 1, 1);
model.result.dataset('cln1').setIndex('genpoints', '-0.00005', 1, 2);
model.result.dataset('cln1').setIndex('genpoints', 0, 1, 1);
model.result.dataset('cln1').setIndex('genpoints', '-0.0005', 1, 2);
model.result.dataset('cln1').setIndex('genpoints', '-0.00005', 1, 2);
model.result.dataset('cln1').setIndex('genpoints', -500, 1, 2);
...
model.label('450_1050_bipolar.mph');

model.component('comp1').mesh('mesh1').feature('size').set('hmax', 1050);
model.component('comp1').mesh('mesh1').feature('ftet1').feature('size1').set('hmax', 450);
model.component('comp1').mesh('mesh1').feature('ftet2').feature('size1').set('hmax', 1050);
model.component('comp1').mesh('mesh1').run;
...
model.result.export('plot1').set('filename', '450_1050_bipolar_EP.txt');
model.result.export('plot1').set('header', false);
model.result.export('plot1').set('sort', true);
model.result.export('plot1').run;
...
model.result.export('plot2').set('filename', '450_1050_bipolar_EF.txt');
model.result.export('plot2').run;
model.result.export('plot3').set('filename', '450_1050_bipolar_AF.txt');
