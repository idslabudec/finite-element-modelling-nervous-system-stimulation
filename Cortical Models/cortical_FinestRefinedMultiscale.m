function out = model
%
% cortical_FinestRefinedMultiscale.m
%
% Model exported on Oct 8 2024, 15:09 by COMSOL 6.2.0.290.
...
model.label('225_525_bipolar.mph');

model.component('comp1').mesh('mesh1').feature('size').set('hmax', 525);
model.component('comp1').mesh('mesh1').feature('ftet2').feature('size1').set('hmax', 525);
model.component('comp1').mesh('mesh1').feature('ftet1').feature('size1').set('hmax', 225);
model.component('comp1').mesh('mesh1').run;
...
model.result.export('plot1').set('filename', '225_525_bipolar_EP.txt');
model.result.export('plot1').run;
...
model.result.export('plot2').set('filename', '225_525_bipolar_EF.txt');
model.result.export('plot2').run;
model.result.export('plot3').set('plotgroup', 'pg7');
model.result.export('plot3').set('filename', '225_525_bipolar_AF.txt');
