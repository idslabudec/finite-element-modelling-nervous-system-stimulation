function out = model
%
% cortical_HighRefinedMultiscale.m
%
...
model.label('300_700_bipolar.mph');
...
model.result.export('plot2').set('filename', '300_700_bipolar_EF.txt');
model.result.export('plot2').run;
model.result.export('plot3').set('plotgroup', 'pg7');
model.result.export('plot3').set('filename', '300_700_bipolar_AF.txt');
