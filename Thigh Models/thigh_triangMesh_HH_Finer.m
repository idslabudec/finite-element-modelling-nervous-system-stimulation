...
model.component('comp1').mesh('mesh1').feature.remove('auto_f1');
model.component('comp1').mesh('mesh1').feature.remove('ftet1');
model.component('comp1').mesh('mesh1').feature('size').set('hauto', 5);
model.component('comp1').mesh('mesh1').run;
model.component('comp1').mesh('mesh1').run;
...
model.study('std3').feature('param').setIndex('plistarr', '52 52.5 53 53.5 54 54.5 55', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'52 52.5 53 53.5 54 54.5 55'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.result.export('anim1').setIndex('singlelooplevel', 4, 1);
model.result.export('anim1').run;
model.result.export('anim1').setIndex('singlelooplevel', 7, 1);
model.result.export('anim1').run;

model.study('std3').feature('param').setIndex('plistarr', '55.5 56 56.5 57 57.5', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'55.5 56 56.5 57 57.5'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', '52 52.5 53 54 55', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'52 52.5 53 54 55'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.result('pg5').run;
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelinput', 'manualindices', 0);
model.result('pg5').feature('lngr1').setIndex('looplevelinput', 'all', 0);
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 5, 1);
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 4, 1);
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 5, 1);
model.result('pg5').run;
...
model.result('pg5').feature('lngr1').setIndex('looplevelinput', 'all', 0);
model.result('pg5').run;
model.result.export('plot1').set('filename', 'actPot_finer_55mA.txt');
model.result.export('plot1').set('header', false);
model.result.export('plot1').set('sort', true);
model.result.export('plot1').run;
model.result.export('anim1').showFrame;
...
model.study('std3').feature('param').setIndex('plistarr', '55 57.5', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'55 57.5'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.result('pg5').run;
model.result.export('plot1').set('filename', 'actPot_finer_57mA.txt');
model.result.export('plot1').run;
...
model.sol('sol1').feature('t1').feature('se1').feature.remove('ssDef');
model.sol('sol1').feature('t1').feature('se1').create('ss1', 'SegregatedStep');
model.sol('sol1').feature('t1').feature('se1').feature('ss1').set('segvar', {'comp1_Ve' 'comp1_ec_term1_V0_ode'});
model.sol('sol1').feature('t1').create('i1', 'Iterative');
model.sol('sol1').feature('t1').feature('i1').set('linsolver', 'cg');
model.sol('sol1').feature('t1').feature('i1').create('mg1', 'Multigrid');
model.sol('sol1').feature('t1').feature('i1').feature('mg1').set('prefun', 'amg');
...
model.result('pg10').feature('lngr1').selection.set([84]);
model.result('pg10').feature('lngr1').set('data', 'dset2');
model.result('pg10').feature('lngr1').setIndex('looplevelinput', 'last', 1);
model.result('pg10').feature('lngr1').setIndex('looplevelinput', 'first', 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevelinput', 'last', 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevelinput', 'all', 0);
model.result('pg10').run;
model.result.export.create('anim4', 'Animation');
model.result.export('anim4').set('target', 'player');
model.result.export('anim4').set('plotgroup', 'pg10');
...
model.result.export('anim4').run;
model.result('pg10').run;
model.result('pg10').feature('lngr1').set('data', 'dset1');
model.result('pg10').run;
model.result('pg10').feature('lngr1').set('data', 'dset2');
model.result('pg10').run;
model.result('pg10').set('data', 'dset2');
...
model.result('pg10').run;
model.result('pg10').feature('lngr1').set('data', 'dset2');
model.result('pg10').feature('lngr1').set('solutionparams', 'parent');
model.result('pg10').run;
model.result('pg10').feature('lngr1').set('solutionparams', 'manual');
model.result('pg10').feature('lngr1').setIndex('looplevelinput', 'manual', 1);
model.result('pg10').feature('lngr1').setIndex('looplevel', [2], 1);
model.result('pg10').feature('lngr1').setIndex('looplevelinput', 'manual', 0);
model.result('pg10').feature('lngr1').setIndex('looplevel', [18], 0);
model.result('pg10').feature('lngr1').setIndex('looplevel', [21], 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [20], 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [36], 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [41], 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [40], 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [39], 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [37], 0);
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [15], 0);
model.result('pg10').run;

model.component('comp1').physics('ec').feature.remove('term1');
model.component('comp1').physics('ec').create('pot1', 'ElectricPotential', 2);
model.component('comp1').physics('ec').feature('pot1').selection.set([13 14 50 51]);
...
model.result('pg10').run;
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [31], 0);
model.result('pg10').run;
model.result.export('anim4').showFrame;
model.result.export('anim1').showFrame;
model.result.export('anim1').run;
...
model.study('std3').feature('param').setIndex('plistarr', '60 65 70', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'60 65 70'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.result('pg5').run;
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 3, 1);
model.result('pg5').run;
model.result('pg10').run;
model.result('pg10').feature('lngr1').setIndex('looplevel', [3], 1);
model.result('pg10').feature('lngr1').setIndex('looplevel', [21], 0);
model.result('pg10').run;

model.study('std3').feature('param').setIndex('plistarr', '75 80 85 90', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'75 80 85 90'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.result('pg5').run;
model.result('pg5').run;
model.result('pg5').setIndex('looplevelinput', 'all', 1);
model.result('pg5').run;
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 1, 1);
model.result('pg5').run;
...
model.study('std3').feature('param').setIndex('plistarr', '71 72.5 74', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'71 72.5 74'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', '73 73.5', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'73 73.5'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
