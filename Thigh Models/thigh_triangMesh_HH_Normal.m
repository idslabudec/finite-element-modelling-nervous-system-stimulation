...
model.label('standardStatic_HH_Normal.mph');
...
model.result.export('plot1').set('filename', 'actPot_Normal_56mA.txt');
model.result.export('plot1').set('header', false);
model.result.export('plot1').set('sort', true);
model.result.export('plot1').run;
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 1, 1);
model.result('pg5').run;
model.result.export('plot1').set('filename', 'actPot_Normal_55mA.txt');
model.result.export('plot1').run;
