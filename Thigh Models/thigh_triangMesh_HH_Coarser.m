function out = model
%
% thigh_triangMesh_HH_Coarser.m
%
% Model exported on Oct 8 2024, 14:59 by COMSOL 6.2.0.290.
...
model.label('standardStatic_HH_ExtCoarser.mph');
...
model.study('std3').feature('param').setIndex('plistarr', '82 84 86 88', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'82 84 86 88'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', '80 80.5 81 81.5 82', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'80 80.5 81 81.5 82'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', 70, 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'70'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', 50, 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'50'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', 60, 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'60'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', '52 54 56 58', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'52 54 56 58'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.study('std3').feature('param').setIndex('plistarr', '56.5 57 57.5', 0);
...
model.batch('p1').feature('so1').set('psol', 'sol2');
model.batch('p1').set('pname', {'I_stim'});
model.batch('p1').set('plistarr', {'56.5 57 57.5'});
model.batch('p1').set('sweeptype', 'sparse');
model.batch('p1').set('probesel', 'all');
model.batch('p1').set('probes', {});
model.batch('p1').set('plot', 'off');
...
model.result.export('anim3').set('giffilename', 'G:\Mi unidad\Doctorado\Electrodos\Interferential\standard50Hz\ExtrCrsr_activ.gif');
...
model.result.export('plot1').set('filename', 'data = load(''actPot_Coarser_55mA.txt'');');
model.result('pg5').run;
model.result.export('plot1').set('filename', 'actPot_Coarser_55mA.txt');
model.result.export('plot1').set('header', false);
model.result.export('plot1').set('sort', true);
model.result.export('plot1').run;
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 3, 1);
model.result('pg5').run;
model.result.export('plot1').set('filename', 'actPot_Coarser_57mA.txt');
model.result.export('plot1').run;
model.result('pg5').run;
model.result('pg5').feature('lngr1').setIndex('looplevelindices', 1, 1);
model.result('pg5').run;

model.label('standardStatic_HH_Coarser.mph');
